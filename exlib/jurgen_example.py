...
"""
	Нужно подумать и написать код короче, вот заготовки функций.
	Если нужно, то создать дополнительные функции или функцию.
	От избытка переменных трудно понять что проиходит.
	Старайся не дублировать код.
"""
...
def get_current_price(pair: str = 'EXM_RUB') -> float:
	"""Получает текущую цену крипто-валюты и возвращает ее"""
